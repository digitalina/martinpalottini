...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			...
			images: {
				prev:		'imagenes/prev.gif',
				next:		'imagenes/next.gif',
				blank:		'imagenes/blank.gif',
		...
		text: {
			...
			of:			'of',
			close:		'Cerrar X',
			closeInfo:	'También puede cliquear fuera de la imagen para cerrar.',
			download:	'Descargar.',
			help: {
				close:		'Click para cerrar',
				interact:	'Posar el cursor sobre la imagen para interactuar'
			},
			about: {
				text: 	'',
				title:	'',
		...
		{	// Resize the boxes
			...
			{	// We want to auto resize
				var maxWidth  = Math.floor(wWidth*(7/8));
				var maxHeight = Math.floor(wHeight*(7/8));
				var resizeRatio;
